...
class myView(discord.ui.View):
    ...
    async def attacker(self,  interaction: discord.interactions, button: discord.ui.Button):
        ...
        await interaction.response.send_message(f"{interaction.user.global_name} got: {attacker}", delete_after=20)
    ...
    async def defender(self,  interaction: discord.interactions, button: discord.ui.Button):
        ...
        await interaction.response.send_message(f"{interaction.user.global_name} got: {defender}" , delete_after=20)
